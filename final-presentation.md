...
- Keep slides clean and readable — avoid walls of text.
- Use visuals: diagrams, screenshots, code snippets where relevant.
...
- **Practice** your presentation at least once before the day.
- **Time yourself** — don't run over your allotted slot.
- **Have a backup plan** for your demo (a pre-recorded video) in case of technical issues.
- **Be ready for questions** — the audience and BJ Hargrave may ask about your technical choices.
- **Tell a story** — the best presentations explain not just *what* you built but *why* it matters.
...
_Back to [Home](README.md) | [Schedule](schedule.md)_
